package net.kiranatos.github.g22tictactoe;

/**
 * Java. Tic Tac Toe 3D
 *
 * @author Sergey Iryupin (Сергей Ирюпин)
 * https://www.youtube.com/user/biblelamp/videos
 * https://www.youtube.com/channel/UC7QtidP4LMVVBlW_pQYkgmQ
 * https://github.com/biblelamp
 * @version 0.10.3 dated Dec 27, 2018
 * 
 * Game: https://github.com/biblelamp/JavaExercises/blob/master/Games/TicTacToe3D/src/TicTacToe3D.java
 */
...
public class StartGameTicTacToe extends JPanel {
    final int RD = 10;
    ...
    private void showMessageDialog(String message) {
        JOptionPane.showMessageDialog(StartGameTicTacToe.this, message);
        gameOver = true;
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            StartGameTicTacToe t3D = new StartGameTicTacToe();
            JFrame f = new JFrame();
