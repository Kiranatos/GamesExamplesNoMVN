 ...
 *  com.javarush.test.level22.lesson18.big01;
 */
public class Tetris {
    ...
    public void run() throws Exception {
        ...
        while (!isGameOver)
        {
            ...
            if (keyboardObserver.hasKeyEvents()) //false - если нечего не нажато
            {
                //получить самое первое событие из очереди
                KeyEvent event = keyboardObserver.getEventFromTop(); //возвращает вершину стека Queue событий
