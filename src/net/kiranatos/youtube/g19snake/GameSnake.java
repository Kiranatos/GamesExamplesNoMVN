package net.kiranatos.youtube.g19snake;
/**
 ...
 * 
 * Video: Пишем классическую игру Snake https://www.youtube.com/watch?v=Zsthou6Ttyc
 */
import java.awt.*;
...
public class GameSnake extends JFrame {
    ...
    final String PATH = "src/net/kiranatos/youtube/g19snake/img/";
    ...
    GameSnake() {
        ...
        try {
            apple = ImageIO.read(new File(PATH + "apple.png"));
            amanita = ImageIO.read(new File(PATH + "amanita.png"));
