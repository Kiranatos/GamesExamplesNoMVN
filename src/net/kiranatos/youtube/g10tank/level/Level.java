...
public class Level {
    ...
    public static final int TILE_IN_WIDTH = Game.WIDTH / SCALED_TILE_SIZE; //50
    public static final int TILE_IN_HEIGHT = Game.HEIGHT / SCALED_TILE_SIZE; //37
    
    //public static final InputStream  LEVEL_ONE_FILE_NAME    = Level.class.getClassLoader().getResourceAsStream("lvl/level1.lvl"); //via Maven
    public static final InputStream  LEVEL_ONE_FILE_NAME    = Level.class.getClassLoader().getResourceAsStream("net/kiranatos/youtube/g10tank/res/lvl/level1.lvl"); //without Maven
